...
export const customers = {
  ...
  cashapp: {
    ...
    contacts: [
      { name: 'Michael Dua', role: 'Head of Product Cash App Card (Champion)', team: 'Product', email: 'michaelduan@squareup.com', linkedin: 'https://www.linkedin.com/in/michael-d', cardswitcher: true, isPrimary: true },
      { name: 'Zainab Lateef', role: 'Product Manager (Building Feature)', team: 'Product', email: 'zainab@squareup.com', linkedin: 'https://www.linkedin.com/in/zainablate', cardswitcher: true, isPrimary: true },
      { name: 'Kyle Woolstenhulme', role: 'Business Partnerships (Primary)', team: 'Partnerships', email: 'kylewoolstenhulme@squareup.com', linkedin: 'https://www.linkedin.com/in/kyle-wools', cardswitcher: true, isPrimary: true },
      { name: 'Janette Chin', role: 'Strategic Payments Partnerships', team: 'Partnerships', email: 'janette@squareup.com', linkedin: 'http://www.linkedin.com/in/janette-chin', cardswitcher: false },
      { name: 'Andrew Steel', role: 'Product Lead Developer Platform', team: 'Product', email: 'asteele@squareup.com', linkedin: 'https://www.linkedin.com/in/andrewlee', cardswitcher: false },
      { name: 'Ricky Graziosi', role: 'Product Lead', team: 'Product', email: 'rgraziosi@squareup.com', linkedin: '', cardswitcher: false },
      ...
      { name: 'Bujar Tagani', role: 'Software Engineer - SDK Lead', team: 'Engineering', email: 'bujar@squareup.com', linkedin: 'https://www.linkedin.com/in/pranay-ma', cardswitcher: false },
      { name: 'Ethan Lee', role: 'Member of Technical Staff', team: 'Engineering', email: 'ethan@squareup.com', linkedin: 'https://www.linkedin.com/in/ethanroser', cardswitcher: false },
      { name: 'Conner Monsees', role: 'Senior Product Designer, Cash App Card', team: 'Design', email: 'cmonsees@squareup.com', linkedin: 'https://www.linkedin.com/in/conner-mc', cardswitcher: false },
      { name: 'Linn Ran', role: 'Marketing Assistant in China', team: 'Marketing', email: 'kunlin@squareup.com', linkedin: 'https://www.linkedin.com/in/linn-ran-ac', cardswitcher: false },
      { name: 'Sonali Upadhyay', role: 'Senior QA Engineer', team: 'Engineering', email: 'supadhye@squareup.com', linkedin: 'https://www.linkedin.com/in/sonali-upa', cardswitcher: false },
      { name: 'Robert Feasley', role: 'Principal Content Designer', team: 'Design', email: 'robertfeasley@squareup.com', linkedin: 'https://www.linkedin.com/in/robertfeas', cardswitcher: false },
      ...
      { name: 'Lauren Copland', role: 'Cross-Block Ecosystem Partnerships Lead', team: 'Partnerships', email: 'lcopland@squareup.com', linkedin: 'http://www.linkedin.com/in/lauren-copl', cardswitcher: false },
      { name: 'Celeste Jackson', role: 'Banking Product Attorney', team: 'Legal', email: 'celestej@squareup.com', linkedin: 'https://linkedin.com/in/celeste-jackson-', cardswitcher: false },
      ...
      { name: 'Carrie Zhang', role: 'Product', team: 'Product', email: 'carrie@squareup.com', linkedin: '', cardswitcher: false },
    ]
  }
